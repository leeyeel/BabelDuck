        ...
        resources: {
            ...
            zh: {
                translation: {
                    ...
                    "BabelDuck 是一款面向各水平层次语言学习者的 AI 口语对话练习应用。除了普通的 AI 对话聊天能力外，我们还提供了一系列为口语练习场景而设计的工具，本教程将为你简单介绍如何使用它们。若你更倾向于自行摸索，可以点击左下角「新建对话」，即可开始体验，之后你依然随时可以回来继续该教程。": "BabelDuck 是一款 AI 口语对话练习应用，在这个基础上我们还提供了一系列为口语练习辅助工具，本教程将为你简单介绍如何使用它们。\n或者你也可以直接点击左下角「新建对话」，直接开始体验。",
